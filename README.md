...
- [x] **Bundled using Vite** - Reorganized my project to fit Vite patterns.
- [x] **Components** - Converted all html pages to react components
- [x] **Router** - Created react router to display stubbed components
