...
2/23/2026
It occurs to me that I should probably be using the provided subsections for organization. Will be doing that from now on.
...
I'm still a little hazy in what it's all for, but it works.
